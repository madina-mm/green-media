...
console.log = function(...args) {
  return oldlog("greenmedia update: " + args);
};
...
async function checkForChanges(cb) {
  exec(
    "git init; git remote add greenmedia https://github.com/nazrin/greenmedia; git fetch greenmedia; git rev-list HEAD...greenmedia/project-oak; git remote remove greenmedia",
    function(err, data) {
...
async function installUpdates(cb) {
  exec(
    "git remote add greenmedia https://github.com/nazrin/greenmedia; git fetch greenmedia; git stash; git pull greenmedia project-oak; git stash apply; git remote remove greenmedia",
    function(err) {
